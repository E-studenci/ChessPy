...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::PAWN = {{
    { 0,   0,    0,   0,   0,   0,  0,   0},
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::END_GAME_PAWN = { {
    {  0,   0,   0,   0,   0,   0,   0,   0},
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::KNIGHT = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::END_GAME_KNIGHT = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::BISHOP = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::END_GAME_BISHOP = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::ROOK = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::END_GAME_ROOK = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::QUEEN = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::END_GAME_QUEEN = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::KING = { {
...
const std::array<std::array<int, 8>, 8> AlgorithmsConsts::END_GAME_KING = { {
