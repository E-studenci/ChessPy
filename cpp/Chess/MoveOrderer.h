...
{
public:
	std::multiset<std::reference_wrapper<Move>> OrderMoves(Board& board, std::map<Coordinates, std::vector<Move>>& moves, bool hashedMove, uint16_t bestMoveHash, bool only_captures=false);
