...
private:
	...
	const std::array<std::array<int, 8>, 8> PAWN{ {
		...
		{  0,    0,    0, 0,   0,   0,  0,   0}} };
	const std::array<std::array<int, 8>, 8> END_GAME_PAWN{ {
		{  0,   0,   0,   0,   0,   0,   0,   0},
		...
		{ 13,   8,   8,  10,  13,   0,   2,  -7},
		{  0,   0,   0,   0,   0,   0,   0,   0}} };
	const std::array<std::array<int, 8>, 8> KNIGHT{ {
	...
	const std::array<std::array<int, 8>, 8> END_GAME_KNIGHT{ {
	...
	const std::array<std::array<int, 8>, 8> BISHOP{ { 
	...
	const std::array<std::array<int, 8>, 8> END_GAME_BISHOP{ { 
		...
		{-14, -18,  -7,  -1,  4,  -9, -15, -27},
		{-23,  -9, -23,  -5, -9, -16,  -5, -17} } };
	const std::array<std::array<int, 8>, 8> ROOK{ { 
	...
	const std::array<std::array<int, 8>, 8> END_GAME_ROOK{ { 
		...
		{-6, -6,  0,  2, -9,  -9, -11,  -3},
		{-9,  2,  3, -1, -5, -13,   4, -20} } };
	const std::array<std::array<int, 8>, 8> QUEEN{ { 
	...
	const std::array<std::array<int, 8>, 8> END_GAME_QUEEN{ { 
	...
	const std::array<std::array<int, 8>, 8> KING{ { 
	...
	const std::array<std::array<int, 8>, 8> END_GAME_KING{ {
	...
	const std::array<int, 12> PIECE_VALUE{ 0, 1025, 337, 365, 477, 82, 0, 1025, 337, 365, 477, 82 };
	const std::array<int, 12> END_GAME_PIECE_VALUE{ 0, 936, 281, 297, 512, 94, 0, 936, 281, 297, 512, 94 };
